<%@ Page Title="Gemba Audit Form" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="GembaAuditNodeForm.aspx.vb" Inherits="GembaAuditNodeForm" %>
...
<%-- ***************--%>    
     <asp:TableCell Width="850px" BorderColor="#666666" BorderStyle="Solid" BorderWidth="1">
        ...
        <asp:Table ID="Table2" runat="server" CellPadding="0" Width="850px"  Height ="900px" CellSpacing="0"  BorderWidth="10" BorderColor="#eeeeee" BackColor="#eeeeee">
         <asp:TableRow Height="10"></asp:TableRow>
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell>
                        <asp:RadioButtonList id=PS_EmptyBinsRL runat="server" RepeatDirection="Horizontal" RepeatLayout="Table" CssClass="fixWidth18" RepeatColumns="6">
                            <asp:ListItem Value="0" Selected="True">5+</asp:ListItem>
 ...
 <%-- Replenishment Standards --%>   
            ...
            <asp:TableRow Width="850px" BackColor="#333333" Height="15">    
                ...
                <asp:TableRow>
                    <asp:TableCell>&nbsp;<asp:Label ID="Label11" runat="server" Text="Node visually swept & corrected"></asp:Label></asp:TableCell>
                    <asp:TableCell>
            ...
            <p> 
                <asp:GridView CssClass="GridViewitem" ID="GridViewImages" DataKeyNames="ImageID"  runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" AllowPaging="False" RowStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" CellSpacing="3" FooterStyle-BackColor="#333333" ShowFooter="True" PageSize="20">
                    <Columns>
                        ...
                        <asp:BoundField DataField="ImageName" HeaderText="ImageName" ItemStyle-Width="100px" />
